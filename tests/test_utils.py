...
from utils import (hex_to_pixel, hex_corners, wrap_coords, all_hexes,
                   ...
                   compute_sun_light, compute_sky_color, compute_lighting,
                   dot3)
...
class TestLighting:
    ...
    def test_compute_lighting_opposite(self):
        ...
        light_dir = (0.0, 0.0, -1.0)
        c, spec = compute_lighting(normal, light_dir, 0.2, (255, 240, 200))
        # When normal points away from light, should get ambient only
        assert c == mul_color((255, 240, 200), 0.2)
        assert spec == 0.0
